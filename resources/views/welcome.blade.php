...
<head>
    ...
    <title>Book Library - Your Digital Reading Companion</title>
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        <div class="flex-shrink-0 flex items-center">
                            <span class="text-2xl font-bold text-indigo-600">BookLib</span>
                        </div>
                    </div>
                    <div class="flex items-center">
                        @if (Route::has('login'))
                            <div class="space-x-4">
                                @auth
                                    <a href="{{ route('books.index') }}" class="text-gray-600 hover:text-gray-900">Dashboard</a>
                                @else
                    ...
                    <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                        <div class="sm:text-center lg:text-left">
                            ...
                            <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                                Explore our vast collection of books, manage your reading list, and connect with other readers. Your digital reading companion is here.
                            </p>
                ...
                <div class="mt-10">
                    <div class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                        <div class="relative">
                            ...
                            <div class="ml-16">
                                <h3 class="text-lg leading-6 font-medium text-gray-900">Extensive Collection</h3>
                                <p class="mt-2 text-base text-gray-500">
                                    Browse through our vast collection of books across various genres and categories.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <div class="ml-16">
                                <h3 class="text-lg leading-6 font-medium text-gray-900">Easy Book Management</h3>
                                <p class="mt-2 text-base text-gray-500">
                                    Keep track of your borrowed books and manage your reading schedule efficiently.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <div class="ml-16">
                                <h3 class="text-lg leading-6 font-medium text-gray-900">Community Reviews</h3>
                                <p class="mt-2 text-base text-gray-500">
                                    Read and share reviews with other readers to discover new perspectives.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <div class="ml-16">
                                <h3 class="text-lg leading-6 font-medium text-gray-900">Personalized Experience</h3>
                                <p class="mt-2 text-base text-gray-500">
            ...
            <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
                ...
                <div class="mt-8 md:mt-0 md:order-1">
                    <p class="text-center text-base text-gray-400">
                        &copy; 2024 Book Library. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
