            ...
            <div class="max-w-2xl mx-auto">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span
                                            class="ml-1 text-gray-900">{{ number_format($book->average_rating, 1) }}</span>
                ...
                <form action="{{ route('book-loans.store', $book) }}" method="POST">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <label for="return_date" class="block text-sm font-medium text-gray-700 mb-2">Expected Return
                                Date</label>
                        ...
                        <div>
                            ...
                            <textarea name="notes" id="notes" rows="3"
                                class="w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('notes') }}</textarea>
                            @error('notes')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            <button type="submit"
                                class="flex-1 px-6 py-3 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                                Submit Loan Request
                            </button>
