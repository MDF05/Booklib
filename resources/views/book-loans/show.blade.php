            ...
            <form id="reviewForm" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center space-x-1" id="ratingStars">
                        ...
                        <i class="fas fa-star text-2xl text-2xl text-gray-300 cursor-pointer hover:text-yellow-400 transition-colors" data-rating="4"></i>
    ...
    .then(data => {
        if (data.success) {
            if (action === 'return') {
                ...
                returnFormData.append('_token', document.querySelector('meta[name="csrf-token"]').getAttribute('content'));
                ...
                .catch(error => {
                    ...
                    alert('Review submitted, but there was an error processing your return request. Please try again.');
                });
            } else {
